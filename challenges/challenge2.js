 ...
 *    Should print name first that prints statement capatalized
 * 
 * 
 ...
 *    Raises an error that name must be string
 * 
 * 
 ...
 *    run the code again.
 *    Prints out the error statement saying something went wrong
 * 
 * 
